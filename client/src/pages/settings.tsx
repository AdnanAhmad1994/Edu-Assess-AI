...
import { Key, CheckCircle, XCircle, Loader2, Eye, EyeOff, Trash2, Sparkles, Shield } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-muted-foreground">No settings available for students.</p>
          </CardContent>
        </Card>
      </div>
    );
